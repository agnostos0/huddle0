  ...
  return (
    <div className="max-w-md mx-auto bg-white p-6 mt-10 rounded shadow">
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        <input className="w-full border px-3 py-2 rounded" placeholder="Email or Username" type="text" value={form.emailOrUsername} onChange={(e)=>setForm({...form, emailOrUsername:e.target.value})} />
